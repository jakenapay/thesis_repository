                ...
                <div class="card p-0">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="file" class="form-control form-control-sm" id="thesis_file" name="thesis_file" accept=".pdf"
                                        <?= ($session->get('user_id') == $graduateThesis[0]['user_id'] && $graduateThesis[0]['status'] == 'revise' && $session->get('user_id') != $graduateThesis[0]['adviser_id']) ? '' : 'disabled'; ?>>
                                    <?php if ($session->get('user_id') == $graduateThesis[0]['user_id'] && $graduateThesis[0]['status'] == 'revise' && $session->get('user_id') != $graduateThesis[0]['adviser_id']): ?>
                            ...
                            $current_status = $graduateThesis[0]['status'];
