                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input
                                        ...
                                        <?= ($session->get('user_id') == $dissertations[0]['user_id'] && $dissertations[0]['status'] == 'revise' && $session->get('user_id') != $dissertations[0]['adviser_id']) ? '' : 'disabled'; ?>>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="department_id" class="form-control form-control-sm" required
                                        <?= ($session->get('user_id') == $dissertations[0]['user_id'] && $dissertations[0]['status'] == 'revise' && $session->get('user_id') != $dissertations[0]['adviser_id'] && $dissertations[0]['status'] != 'revise') ? '' : 'disabled'; ?>>
                                        ...
                                        <?php foreach ($department as $dept): ?>
                                            <option value="<?= esc($dept['id']); ?>"
                                                ...
                                                if ($dissertations[0]['department_id'] == $dept['id']) {
                                                    if ($session->get('user_id') == $dissertations[0]['adviser_id'] && $session->get('is_adviser') == 1) {
                                                        echo ' (Me)';
                                                    }
                                                }
                                                ?>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="adviser_id" class="form-control form-control-sm" required
                                        <?= ($session->get('user_id') == $dissertations[0]['user_id'] &&
                                            $dissertations[0]['status'] == 'revise' &&
                                            $session->get('user_id') != $dissertations[0]['adviser_id'] &&
                                            $dissertations[0]['status'] != 'revise') ? '' : 'disabled'; ?>>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="<?= ($dissertations[0]['status'] == 'revise') ? 'bg-danger text-light' : '' ?> form-control form-control-sm text-capitalize" name="status" value="<?= (!empty($dissertations[0]['status'])) ? $dissertations[0]['status'] : '' ?>" readonly>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="file" class="form-control form-control-sm" id="thesis_file" name="thesis_file" accept=".pdf"
                                        <?= ($session->get('user_id') == $dissertations[0]['user_id'] && $dissertations[0]['status'] == 'revise' && $session->get('user_id') != $dissertations[0]['adviser_id']) ? '' : 'disabled'; ?>>
                                    <?php if ($session->get('user_id') == $dissertations[0]['user_id'] && $dissertations[0]['status'] == 'revise' && $session->get('user_id') != $dissertations[0]['adviser_id']): ?>
                            ...
                            <div class="col-md-12 mb-2 d-flex justify-content-end gap-2">
                                <!-- <a href="<?= base_url('documents/dissertations/download/' . $dissertations[0]['id']); ?>" class="btn btn-danger btn-sm px-5">
                                 ...
                                 <a href="<?= base_url('documents/viewDocument/' . $dissertations[0]['id']); ?>" class="btn btn-danger btn-sm px-5" target="_blank">
                                ...
                                if ($session->get('user_id') == $dissertations[0]['user_id'] && $dissertations[0]['status'] == 'revise' && $session->get('user_id') != $dissertations[0]['adviser_id']) {                               
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <?php endif; ?>
                                    <hr>
                                    <p class="m-0 text-muted fst-italic">Uploaded on: <?= date('F j, Y', strtotime($dissertations[0]['uploaded_at'])); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
