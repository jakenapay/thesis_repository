<div class="container mt-4">
    <div class="row d-flex min-vh-100">
        <div class="col-md-8">
            <form action="<?= base_url('documents/dissertations/edit/' . $graduateThesis[0]['id']); ?>" method="POST" enctype="multipart/form-data" class="row g-3">
                <!-- Contact Card -->
                <div class="card p-0">
                    <div class="card-header bg-red text-light fw-bold d-flex justify-content-between align-items-center">
                        <span>View Graduate Thesis</span>
                        <!-- <span class="small text-light">
                            <i class="fas fa-eye me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="View Count"></i><?= $graduateThesis[0]['view_count']; ?>
                            <i class="fas fa-download ms-2 me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Download Count"></i><?= $graduateThesis[0]['download_count']; ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input
                                        ...
                                        <?= ($session->get('user_id') == $graduateThesis[0]['user_id'] ? '' : 'disabled'); ?>>
                                </div>
                                    ...
                                    <select name="department_id" class="form-control form-control-sm" required
                                        ...
                                        <?php foreach ($department as $dept): ?>
                                            <option value="<?= esc($dept['id']); ?>"
                                                <?= ($graduateThesis[0]['department_id'] == $dept['id']) ? 'selected' : ''; ?>>
                                                <?= esc($dept['name']); ?>
                                                <?php
                                                if ($graduateThesis[0]['department_id'] == $dept['id']) {
                                    ...
                                    <select name="adviser_id" class="form-control form-control-sm" required
                                        ...
                                        <?php foreach ($advisers as $adviser): ?>
                                            <option value="<?= esc($adviser['id']); ?>"
                                                <?= ($graduateThesis[0]['adviser_id'] == $adviser['id']) ? 'selected' : ''; ?>>
                                ...
                                <!-- tags -->
                                <div class="col-md-6 mb-4">
                                    <label class="form-label">Tags <?= ($session->get('user_id') == $graduateThesis[0]['user_id']) ? '<small class="text-muted text-red">(optional)</small>' : ''; ?></label>
