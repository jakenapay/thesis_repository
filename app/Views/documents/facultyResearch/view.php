                ...
                <div class="card p-0">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="department_id" class="form-control form-control-sm" required
                                        <?= ($session->get('user_id') == $facultyResearch[0]['user_id'] && $facultyResearch[0]['status'] == 'revise' && $session->get('user_id') != $facultyResearch[0]['adviser_id'] && $facultyResearch[0]['status'] != 'revise') ? '' : 'disabled'; ?>>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="adviser_id" class="form-control form-control-sm" required
                                        <?= ($session->get('user_id') == $facultyResearch[0]['user_id'] && $facultyResearch[0]['status'] == 'revise' && $session->get('user_id') != $facultyResearch[0]['adviser_id']  &&
                                            $facultyResearch[0]['status'] != 'revise') ? '' : 'disabled'; ?>>
                                        ...
                                        <?php foreach ($advisers as $adviser): ?>
                                            <option value="<?= esc($adviser['id']); ?>"
                                                ...
                                                if ($facultyResearch[0]['adviser_id'] == $adviser['id']) {
                                                    if ($session->get('user_id') == $facultyResearch[0]['adviser_id'] && $session->get('is_adviser') == 1) {
                                                        echo ' (Me)';
                                                    }
                                                }
                                                ?>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="<?= ($facultyResearch[0]['status'] == 'revise') ? 'bg-danger text-light' : '' ?> form-control form-control-sm text-capitalize" name="status" value="<?= (!empty($facultyResearch[0]['status'])) ? $facultyResearch[0]['status'] : '' ?>" readonly>
                                </div>
                            ...
                            $current_status = $facultyResearch[0]['status'];
                            ...
                            <?php } else if ($user_level == 'masters' && $facultyResearch[0]['user_id'] == $session->get('user_id') && $facultyResearch[0]['status'] == 'revise' || $user_level == 'faculty' && $facultyResearch[0]['user_id'] == $session->get('user_id') && $facultyResearch[0]['status'] == 'revise' ) { ?>
                                    <!-- Remarks-->
                                    <div class="col-md-6 mb-4 ">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <?php endif; ?>
                                    <hr>
                                    <p class="m-0 text-muted fst-italic">Uploaded on: <?= date('F j, Y', strtotime($facultyResearch[0]['uploaded_at'])); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
