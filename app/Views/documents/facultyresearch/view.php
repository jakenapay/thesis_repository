                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input
                                        ...
                                        <?= ($session->get('user_id') == $facultyResearch[0]['user_id'] && $facultyResearch[0]['status'] == 'rejected' && $session->get('user_id') != $facultyResearch[0]['adviser_id']) ? '' : 'disabled'; ?>>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="department_id" class="form-control form-control-sm" required
                                        <?= ($session->get('user_id') == $facultyResearch[0]['user_id'] && $facultyResearch[0]['status'] == 'rejected' && $session->get('user_id') != $facultyResearch[0]['adviser_id'] && $facultyResearch[0]['status'] != 'rejected') ? '' : 'disabled'; ?>>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="adviser_id" class="form-control form-control-sm" required
                                        <?= ($session->get('user_id') == $facultyResearch[0]['user_id'] && $facultyResearch[0]['status'] == 'rejected' && $session->get('user_id') != $facultyResearch[0]['adviser_id']  &&
                                            $facultyResearch[0]['status'] != 'rejected') ? '' : 'disabled'; ?>>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="<?= ($facultyResearch[0]['status'] == 'rejected') ? 'bg-danger text-light' : '' ?> form-control form-control-sm text-capitalize" name="status" value="<?= (!empty($facultyResearch[0]['status'])) ? $facultyResearch[0]['status'] : '' ?>" readonly>
                                </div>
                            ...
                            <div class="col-md-12 mb-2 d-flex justify-content-end gap-2">
                                ...
                                if ($session->get('user_id') == $facultyResearch[0]['user_id'] && $facultyResearch[0]['status'] == 'rejected' && $session->get('user_id') != $facultyResearch[0]['adviser_id']) {
